...
def test():
    ...
    # ID = 'id'
    # DATA_COLUMN = 'body'
    # LABEL_COLUMNS = ['matlab', 'svm', 'tensorflow', 'data-mining', 'scikit-learn', 'classification', 'nlp',
    #                  'computer-vision']
    #
    ...
    #         # loss = tf.reduce_mean(per_example_loss)
    #
    #         return (loss, per_example_loss, logits, probabilities, acc)
    #
    ...
    #
    #         (total_loss, per_example_loss, logits, probabilities, acc) = create_model(
    ...
    #
    #         output_spec = None
    #         logging_hook = tf.train.LoggingTensorHook({"loss": total_loss, "accuracy": acc}, every_n_iter=1)
    ...
    #         "label_ids": tf.FixedLenFeature([8], tf.int64),
    ...
    if not recv == '':
        ...
        # result_str = ''
        #
        # prb = list(predictions)[0]['probabilities']
        #
        #
        # for i in range(8):
        #     result_str += LABEL_COLUMNS[i]
        #     result_str += ': '
